...
warsaw_wgs84_100 <- 
  read.table('data/raw/warsaw_wgs84_every_100m.txt') %>%
...
ggsave('sample-based-whyr-github/plots/warsaw_wgs84_every_100m.png')
...
ggsave('sample-based-whyr-github/plots/warsaw_wgs84_every_500m.png')
...
ggsave('sample-based-whyr-github/plots/warsaw_wgs84_every_1000m.png')


ggplot(warsaw_wgs84_2000, aes(x = longitude, y = latitude, col = district_name)) +
  geom_point() +
  coord_map() + 
  theme_minimal() +
  theme(legend.position = 'None') +
  labs(title = 'Warsaw, every 2000m') 
ggsave('sample-based-whyr-github/plots/warsaw_wgs84_every_2000m.png')
